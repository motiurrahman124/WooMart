...
<div class="checkout-page pb-60">
    <div class="container">
        <div class="multisteps-form">
            ...
            <div class="row">
              <div class="col-lg-12">
                <form action="{{ route('billing.store') }}" method="POST" class="multisteps-form__form">
                    @csrf
                    <!--single form panel-->
                        ...
                        <div class="multisteps-form__content">
                            <div class="check-out-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="fullname" name="fullname" value="{{ $user->name }}" required placeholder="Full Name" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="phone" name="phone" value="{{ $user->phone }}" required placeholder="Phone" />
                                </div>
                                <div class="form-group">
