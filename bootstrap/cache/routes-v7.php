...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::i4UYwOy6Qxv217Qa',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::IOmhZLe2RpS0xyC2',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      '/profile/password-change-process' => 
      array (
        0 => 
        array (
          0 => 
          array (
            '_route' => 'password.change.process',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/product/([^/]++)(*:24)|/blog/single\\-blog/([^/]++)(*:58)|/cart/remove/([^/]++)(*:86)|/Wishlist/remove/([^/]++)(*:118)|/admin/(?|b(?|log\\-(?|edit/([^/]++)(*:161)|delete/([^/]++)(*:184))|rand/(?|edit/([^/]++)(*:214)|delete/([^/]++)(*:237)))|slider/(?|edit/([^/]++)(*:270)|delete/([^/]++)(*:293))|c(?|ategory/(?|edit/([^/]++)(*:330)|delete/([^/]++)(*:353))|ontact/read/([^/]++)(*:382))|product/(?|e(?|nable(?|/([^/]++)(*:423)|\\-disable/([^/]++)(*:449))|dit/([^/]++)(*:470))|d(?|isable/([^/]++)(*:498)|elete/([^/]++)(*:520)))|order/invoice/([^/]++)(*:552)))/?$}sDu',
    ),
    3 => 
    array (
      24 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserAuthController@signin',
        'controller' => 'App\\Http\\Controllers\\UserAuthController@signin',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserAuthController@signup',
        'controller' => 'App\\Http\\Controllers\\UserAuthController@signup',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\User\\ProfileController@passwordChange',
        'controller' => 'App\\Http\\Controllers\\User\\ProfileController@passwordChange',
        'namespace' => NULL,
        'prefix' => '/profile',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'profile/password-change-process',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\User\\ProfileController@passwordChangeProcess',
        'controller' => 'App\\Http\\Controllers\\User\\ProfileController@passwordChangeProcess',
        'namespace' => NULL,
        'prefix' => '/profile',
        'where' => 
        array (
        ),
        'as' => 'password.change.process',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\BlogController@single_blog',
        'controller' => 'App\\Http\\Controllers\\BlogController@single_blog',
        'namespace' => NULL,
        'prefix' => '/blog',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'cart/checkout/billing/store',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\CheckoutController@billingStore',
        'controller' => 'App\\Http\\Controllers\\CheckoutController@billingStore',
        'namespace' => NULL,
        'prefix' => 'cart/checkout',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'controller' => 'App\\Http\\Controllers\\CheckoutController@shipping',
        'namespace' => NULL,
        'prefix' => 'cart/checkout',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'cart/checkout/shippin/store',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CheckoutController@paymnet',
        'controller' => 'App\\Http\\Controllers\\CheckoutController@paymnet',
        'namespace' => NULL,
        'prefix' => 'cart/checkout',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'cart/checkout/stripe-payment',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\CheckoutController@stripePaymnet',
        'controller' => 'App\\Http\\Controllers\\CheckoutController@stripePaymnet',
        'namespace' => NULL,
        'prefix' => 'cart/checkout',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Dashboard\\AuthController@login',
        'controller' => 'App\\Http\\Controllers\\Dashboard\\AuthController@login',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Dashboard\\AuthController@adminCheck',
        'controller' => 'App\\Http\\Controllers\\Dashboard\\AuthController@adminCheck',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\BlogController@createBlog',
        'controller' => 'App\\Http\\Controllers\\Admin\\BlogController@createBlog',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\BlogController@createNewBlog',
        'controller' => 'App\\Http\\Controllers\\Admin\\BlogController@createNewBlog',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'controller' => 'App\\Http\\Controllers\\Admin\\SliderController@delete',
        'namespace' => NULL,
        'prefix' => 'admin/slider',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\ProductController@enable',
        'controller' => 'App\\Http\\Controllers\\Admin\\ProductController@enable',
        'namespace' => NULL,
        'prefix' => 'admin/product',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'admin/product/disable/{slug}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\ProductController@disable',
        'controller' => 'App\\Http\\Controllers\\Admin\\ProductController@disable',
        'namespace' => NULL,
        'prefix' => 'admin/product',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'admin/product/enable-disable/{id}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\ProductController@enableDisable',
        'controller' => 'App\\Http\\Controllers\\Admin\\ProductController@enableDisable',
        'namespace' => NULL,
        'prefix' => 'admin/product',
        'where' => 
        array (
        ),
        'as' => 'product.enableDisable',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\ContactController@read',
        'controller' => 'App\\Http\\Controllers\\Admin\\ContactController@read',
        'namespace' => NULL,
        'prefix' => 'admin/contact',
        'where' => 
        array (
