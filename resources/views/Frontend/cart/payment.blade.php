...
<div class="checkout-page pb-60">
    <div class="container">
        <div class="multisteps-form">
            ...
            <div class="row">
              <div class="col-lg-12">
                <form action="{{ route('stripe.payment') }}" method="POST" class="multisteps-form__form">
                    @csrf
                    <!--single form panel-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="check-out-form">
                                        <div class="credit-card">
                                            ...
                                            <label class="form-check-label" for="exampleRadios1">
                                                ...
                                                <img src="{{ asset('assets/mainpage/images/credit-card.png') }}" alt="credit-card" />
                                            </label>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <img class="form-img" src="{{ asset('assets/mainpage/images/p-mastercard.png') }}" alt="p-mastercard" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <select class="niceselect " name="exp_month">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <select class="niceselect " name="exp_year">
                                        ...
                                        <div class="credit-card">
                                            ...
                                            <label class="form-check-label" for="exampleRadios2">
                                                ...
                                                <img src="{{ asset('assets/mainpage/images/p-paypal.png') }}" alt="credit-card" />
                                            </label>
                                        </div>
                                    </div>
                                    <div class="button-row d-flex justify-content-end">
                                        ...
                                        <button type="submit" class="btn next js-btn-next" type="button" title="Next">Place Order</button>
                                    </div>
                                </div>
                            </div>
                        </div>
